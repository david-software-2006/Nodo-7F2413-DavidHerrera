...
const pokemonStats = document.querySelectorAll('.pokemon-stats');

// Selectores para el Pokemon 1
var hpPoke1 = document.querySelector('.pokemon-1__hp');
var nmPoke1 = document.querySelector('.pokemon-1__name');
var atPoke1 = document.querySelector('.pokemon-1__attack');
var dfPoke1 = document.querySelector('.pokemon-1__defense');
var tpPoke1 = document.querySelector('.pokemon-1__type');
// Selectores para el Pokemon 2
var hpPoke2 = document.querySelector('.pokemon-2__hp');
var nmPoke2 = document.querySelector('.pokemon-2__name');
var atPoke2 = document.querySelector('.pokemon-2__attack');
var dfPoke2 = document.querySelector('.pokemon-2__defense');
var tpPoke2 = document.querySelector('.pokemon-2__type');
